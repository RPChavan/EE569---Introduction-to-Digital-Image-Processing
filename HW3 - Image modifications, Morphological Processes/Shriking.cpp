...
std::vector<short> S11{0,0,1,0,1,0,0,0,0};
std::vector<short> S12{1,0,0,0,1,0,0,0,0};
std::vector<short> S13{0,0,0,0,1,0,1,0,0};
std::vector<short> S14{0,0,0,0,1,0,0,0,1};
             
std::vector<short> S21{0,0,0,0,1,1,0,0,0};
std::vector<short> S22{0,1,0,0,1,0,0,0,0};
std::vector<short> S23{0,0,0,1,1,0,0,0,0};
std::vector<short> S24{0,0,0,0,1,0,0,1,0};
			
std::vector<short> S31{0,0,1,0,1,1,0,0,0};
std::vector<short> S32{0,1,1,0,1,0,0,0,0};
std::vector<short> S33{1,1,0,0,1,0,0,0,0};
std::vector<short> S34{1,0,0,1,1,0,0,0,0};
std::vector<short> S35{0,0,0,1,1,0,1,0,0};
std::vector<short> S36{0,0,0,0,1,0,1,1,0};
std::vector<short> S37{0,0,0,0,1,0,0,1,1};
std::vector<short> S38{0,0,0,0,1,1,0,0,1};

...
for(i = 0; i < Row_Size; i++)
	{
		...
		f[i][j][0] = 255 - int(Imagedata[i][j][0]);
		//cout<<f[i][j]<<"   ";
		}
		cout<<endl;
	}
	...
	for(i = 0; i < Row_Size; i++)
	{
		...
		{
			//cout<<f[i][j][0]<<"    ";
			Output_Image[i][j][0] = (unsigned char)(255-f[i][j][0]);
		}
		//cout<<endl;
	}
	...
	for(i = 0; i < Row_Size; i++)
	{
		...
		{
	    //cout<<int(Imagedata[i][j][0])<<"   ";
		f[i][j][0] = 255 - int(Imagedata[i][j][1]);
		//cout<<f[i][j]<<"   ";
		}
		cout<<endl;
	}
	...
	for(i = 0; i < Row_Size; i++)
	{
		...
		{
			//cout<<f[i][j][0]<<"    ";
			Output_Image[i][j][1] = (unsigned char)(255-f[i][j][0]);
		}
		//cout<<endl;
	}
...
for(i = 0; i < Row_Size; i++)
	{
		...
		{
	    //cout<<int(Imagedata[i][j][0])<<"   ";
		f[i][j][0] = 255 - int(Imagedata[i][j][2]);
		//cout<<f[i][j]<<"   ";
		}
		cout<<endl;
	}
	...
	for(i = 0; i < Row_Size; i++)
	{
		...
		{
			//cout<<f[i][j][0]<<"    ";
			Output_Image[i][j][2] = (unsigned char)(255-f[i][j][0]);
		}
		//cout<<endl;
	}
